import { whatsappUrl, WHATSAPP_DEFAULT_MESSAGE } from "@/lib/constants";
...
export default function WhatsAppButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-md px-6 py-3 text-sm font-medium tracking-wide transition-all duration-300 hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2";
